...
Full Changelog: [v0.1.0-alpha.11...v0.1.0-alpha.12](https://github.com/moonbaseai/moonbase-sdk-ruby/compare/v0.1.0-alpha.11...v0.1.0-alpha.12)

### Chores

* **internal:** allow the mock server port to be set with STAINLESS_MOCK_PORT ([302b976](https://github.com/moonbaseai/moonbase-sdk-ruby/commit/302b976a2de50e5329522189f38eccd6963dbd2e))
...
* **api:** add agent settings update method ([c86d77c](https://github.com/moonbaseai/moonbase-sdk-ruby/commit/c86d77c5e836747d28c97a0f885a8e0aba96272f))
* **api:** add attachment create/delete methods to inbox_messages ([c86d77c](https://github.com/moonbaseai/moonbase-sdk-ruby/commit/c86d77c5e836747d28c97a0f885a8e0aba96272f))
* **api:** add collection create and update methods ([c86d77c](https://github.com/moonbaseai/moonbase-sdk-ruby/commit/c86d77c5e836747d28c97a0f885a8e0aba96272f))
* **api:** add default_values support on all field types ([c86d77c](https://github.com/moonbaseai/moonbase-sdk-ruby/commit/c86d77c5e836747d28c97a0f885a8e0aba96272f))
* **api:** add field create, update, and delete methods to collections.fields ([c86d77c](https://github.com/moonbaseai/moonbase-sdk-ruby/commit/c86d77c5e836747d28c97a0f885a8e0aba96272f))
* **api:** add File results to search response, change data to Item | File union ([c86d77c](https://github.com/moonbaseai/moonbase-sdk-ruby/commit/c86d77c5e836747d28c97a0f885a8e0aba96272f))
* **api:** add form create, update, and delete methods ([c86d77c](https://github.com/moonbaseai/moonbase-sdk-ruby/commit/c86d77c5e836747d28c97a0f885a8e0aba96272f))
* **api:** add funnels CRUD methods (list, retrieve, create, update, delete) ([c86d77c](https://github.com/moonbaseai/moonbase-sdk-ruby/commit/c86d77c5e836747d28c97a0f885a8e0aba96272f))
* **api:** add identifier field and value types ([9a5209b](https://github.com/moonbaseai/moonbase-sdk-ruby/commit/9a5209bdedc6645101094d40e98590110f6f4e52))
* **api:** add merge method to collections.items ([c86d77c](https://github.com/moonbaseai/moonbase-sdk-ruby/commit/c86d77c5e836747d28c97a0f885a8e0aba96272f))
* **api:** add stage field create/update support via funnel pointer ([c86d77c](https://github.com/moonbaseai/moonbase-sdk-ruby/commit/c86d77c5e836747d28c97a0f885a8e0aba96272f))
* **api:** add Tag color field and business_email_required to Form ([c86d77c](https://github.com/moonbaseai/moonbase-sdk-ruby/commit/c86d77c5e836747d28c97a0f885a8e0aba96272f))
* **api:** add tags param to calls create/upsert and meetings update ([c86d77c](https://github.com/moonbaseai/moonbase-sdk-ruby/commit/c86d77c5e836747d28c97a0f885a8e0aba96272f))
* **api:** add tagset create, update, and delete methods with tag color ([c86d77c](https://github.com/moonbaseai/moonbase-sdk-ruby/commit/c86d77c5e836747d28c97a0f885a8e0aba96272f))
...
* **api:** rename LlmProfile to AgentSettings, remove model fields ([c86d77c](https://github.com/moonbaseai/moonbase-sdk-ruby/commit/c86d77c5e836747d28c97a0f885a8e0aba96272f))
* **api:** replace Collection core field with kind enum (system, form, custom) ([c86d77c](https://github.com/moonbaseai/moonbase-sdk-ruby/commit/c86d77c5e836747d28c97a0f885a8e0aba96272f))
* **api:** return InboxConversationPointer and EmailMessagePointer from inbox list endpoints, flatten filter params ([c86d77c](https://github.com/moonbaseai/moonbase-sdk-ruby/commit/c86d77c5e836747d28c97a0f885a8e0aba96272f))
* **api:** return ItemPointer from items list, remove include param ([c86d77c](https://github.com/moonbaseai/moonbase-sdk-ruby/commit/c86d77c5e836747d28c97a0f885a8e0aba96272f))
* **api:** return MeetingPointer from meetings list, flatten filter param ([c86d77c](https://github.com/moonbaseai/moonbase-sdk-ruby/commit/c86d77c5e836747d28c97a0f885a8e0aba96272f))
* **api:** return PartialCollection from collections list, remove include param ([c86d77c](https://github.com/moonbaseai/moonbase-sdk-ruby/commit/c86d77c5e836747d28c97a0f885a8e0aba96272f))
* **api:** unified activity response with constituents array, restructured activity filters ([c86d77c](https://github.com/moonbaseai/moonbase-sdk-ruby/commit/c86d77c5e836747d28c97a0f885a8e0aba96272f))
...
* **internal:** extract 13 nested types to top-level models ([c86d77c](https://github.com/moonbaseai/moonbase-sdk-ruby/commit/c86d77c5e836747d28c97a0f885a8e0aba96272f))
...
* **types:** remove MessageAttachmentCreateParams, flatten AttachmentCreateParams ([eaaf037](https://github.com/moonbaseai/moonbase-sdk-ruby/commit/eaaf037358059a0d7a756a0d0f432b251200955a))
