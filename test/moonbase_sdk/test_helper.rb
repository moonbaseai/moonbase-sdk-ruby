...
class MoonbaseSDK::Test::SingletonClient < MoonbaseSDK::Client
  include Singleton

  TEST_API_BASE_URL = ENV.fetch("TEST_API_BASE_URL", "http://localhost:4010")

  def initialize
    super(base_url: MoonbaseSDK::Test::SingletonClient::TEST_API_BASE_URL, api_key: "My API Key")
  end
end
...
class MoonbaseSDK::Test::ResourceTest < Minitest::Test
  def async?
  ...
  def before_all
    super
    @moonbase = MoonbaseSDK::Test::SingletonClient.instance
  end
