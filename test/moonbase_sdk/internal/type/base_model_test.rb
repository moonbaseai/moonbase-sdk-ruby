...
class MoonbaseSDK::Test::PrimitiveModelTest < Minitest::Test
  A = MoonbaseSDK::Internal::Type::ArrayOf[-> { Integer }]
  H = MoonbaseSDK::Internal::Type::HashOf[-> { Integer }, nil?: true]
  ...
  class B < MoonbaseSDK::Internal::Type::BaseModel
    optional :a, Integer
    optional :b, B
  end
  ...
  def test_typing
    converters = [
      MoonbaseSDK::Internal::Type::Unknown,
      MoonbaseSDK::Internal::Type::Boolean,
      A,
      H,
      E,
      U,
    ...
    converters.each do |conv|
      assert_pattern do
        conv => MoonbaseSDK::Internal::Type::Converter
      end
    end
  end
  ...
  def test_coerce
    cases = {
      [MoonbaseSDK::Internal::Type::Unknown, :a] => [{yes: 1}, :a],
      [NilClass, :a] => [{maybe: 1}, nil],
      [NilClass, nil] => [{yes: 1}, nil],
      [MoonbaseSDK::Internal::Type::Boolean, true] => [{yes: 1}, true],
      [MoonbaseSDK::Internal::Type::Boolean, "true"] => [{no: 1}, "true"],
      [Integer, 1] => [{yes: 1}, 1],
    ...
    cases.each do |lhs, rhs|
      ...
      state = MoonbaseSDK::Internal::Type::Converter.new_coerce_state
      assert_pattern do
        MoonbaseSDK::Internal::Type::Converter.coerce(target, input, state: state) => ^expect
  ...
  def test_dump
    cases = {
      [MoonbaseSDK::Internal::Type::Unknown, B.new(a: "one", b: B.new(a: 1.0))] => {a: "one", b: {a: 1}},
      ...
      [MoonbaseSDK::Internal::Type::Boolean, true] => true,
      [MoonbaseSDK::Internal::Type::Boolean, "true"] => "true",
      [Integer, "1"] => "1",
      [Float, 1] => 1,
      [String, "one"] => "one",
      ...
      [String, Pathname(__FILE__)] => MoonbaseSDK::FilePart
    }
    ...
    cases.each do
      ...
      expect = _2
      assert_pattern do
        MoonbaseSDK::Internal::Type::Converter.dump(target, input) => ^expect
      end
    end
  end
  ...
  def test_coerce_errors
    ...
    cases.each do |testcase, expect|
      ...
      state = MoonbaseSDK::Internal::Type::Converter.new_coerce_state
      MoonbaseSDK::Internal::Type::Converter.coerce(target, input, state: state)
      assert_pattern do
        state => {error: ^expect}
      end
    end
  ...
  def test_dump_retry
    ...
    Pathname(__FILE__).open do |fd|
      ...
      types.product(cases).each do |target, input|
        ...
        MoonbaseSDK::Internal::Type::Converter.dump(target, input, state: state)
...
class MoonbaseSDK::Test::EnumModelTest < Minitest::Test
  class E0
    include MoonbaseSDK::Internal::Type::Enum
    attr_reader :values
...
class MoonbaseSDK::Test::CollectionModelTest < Minitest::Test
  A1 = MoonbaseSDK::Internal::Type::ArrayOf[-> { Integer }]
  H1 = MoonbaseSDK::Internal::Type::HashOf[Integer]

  A2 = MoonbaseSDK::Internal::Type::ArrayOf[H1]
  H2 = MoonbaseSDK::Internal::Type::HashOf[-> { A1 }]

  A3 = MoonbaseSDK::Internal::Type::ArrayOf[Integer, nil?: true]
  H3 = MoonbaseSDK::Internal::Type::HashOf[Integer, nil?: true]
...
class MoonbaseSDK::Test::BaseModelTest < Minitest::Test
  class M1 < MoonbaseSDK::Internal::Type::BaseModel
    required :a, Integer
  end
  ...
  class M3 < MoonbaseSDK::Internal::Type::BaseModel
    optional :c, const: :c
    required :d, const: :d
  end
  ...
  class M5 < MoonbaseSDK::Internal::Type::BaseModel
    request_only do
      required :c, const: :c
    end
  ...
  class M6 < M1
    required :a, MoonbaseSDK::Internal::Type::ArrayOf[M6]
    optional :b, M6
  end
  ...
  def test_coerce
    ...
    cases.each do |lhs, rhs|
      ...
      state = MoonbaseSDK::Internal::Type::Converter.new_coerce_state
      assert_pattern do
        coerced = MoonbaseSDK::Internal::Type::Converter.coerce(target, input, state: state)
        assert_equal(coerced, coerced)
        if coerced.is_a?(MoonbaseSDK::Internal::Type::BaseModel)
          coerced.to_h => ^expect
        else
          coerced => ^expect
        end
      ...
      attributes.each do |accessor, expect|
        ...
        in Class if expect <= StandardError
          tap do
            ...
            flunk
          rescue MoonbaseSDK::Errors::ConversionError => e
...
class MoonbaseSDK::Test::UnionTest < Minitest::Test
  class U0
    include MoonbaseSDK::Internal::Type::Union
  ...
  class M2 < MoonbaseSDK::Internal::Type::BaseModel
  ...
  class M4 < MoonbaseSDK::Internal::Type::BaseModel
    optional :recur, -> { U5 }
    required :a, MoonbaseSDK::Internal::Type::ArrayOf[-> { U5 }]
  end

  class M5 < MoonbaseSDK::Internal::Type::BaseModel
    optional :recur, -> { U5 }
    required :b, MoonbaseSDK::Internal::Type::ArrayOf[-> { U5 }]
  end
...
class MoonbaseSDK::Test::BaseModelQoLTest < Minitest::Test
  class E0
    include MoonbaseSDK::Internal::Type::Enum
    attr_reader :values
  ...
  def test_equality
    cases = {
      [MoonbaseSDK::Internal::Type::Unknown, MoonbaseSDK::Internal::Type::Unknown] => true,
      [MoonbaseSDK::Internal::Type::Boolean, MoonbaseSDK::Internal::Type::Boolean] => true,
      [MoonbaseSDK::Internal::Type::Unknown, MoonbaseSDK::Internal::Type::Boolean] => false,
