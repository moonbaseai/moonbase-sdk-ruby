...
class Moonbase::Test::SingletonClient < Moonbase::Client
  include Singleton

  TEST_API_BASE_URL = ENV.fetch("TEST_API_BASE_URL", "http://localhost:4010")

  def initialize
    super(base_url: Moonbase::Test::SingletonClient::TEST_API_BASE_URL, api_key: "My API Key")
  end
end
...
class Moonbase::Test::ResourceTest < Minitest::Test
  def async?
  ...
  def before_all
    super
    @moonbase = Moonbase::Test::SingletonClient.instance
  end
