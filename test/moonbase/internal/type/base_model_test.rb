...
class Moonbase::Test::PrimitiveModelTest < Minitest::Test
  A = Moonbase::Internal::Type::ArrayOf[-> { Integer }]
  H = Moonbase::Internal::Type::HashOf[-> { Integer }, nil?: true]
  ...
  class B < Moonbase::Internal::Type::BaseModel
    optional :a, Integer
    optional :b, B
  end
  ...
  def test_typing
    converters = [
      Moonbase::Internal::Type::Unknown,
      Moonbase::Internal::Type::Boolean,
      A,
      H,
      E,
      U,
    ...
    converters.each do |conv|
      assert_pattern do
        conv => Moonbase::Internal::Type::Converter
      end
    end
  end
  ...
  def test_coerce
    cases = {
      [Moonbase::Internal::Type::Unknown, :a] => [{yes: 1}, :a],
      [NilClass, :a] => [{maybe: 1}, nil],
      [NilClass, nil] => [{yes: 1}, nil],
      [Moonbase::Internal::Type::Boolean, true] => [{yes: 1}, true],
      [Moonbase::Internal::Type::Boolean, "true"] => [{no: 1}, "true"],
      [Integer, 1] => [{yes: 1}, 1],
    ...
    cases.each do |lhs, rhs|
      ...
      state = Moonbase::Internal::Type::Converter.new_coerce_state
      assert_pattern do
        Moonbase::Internal::Type::Converter.coerce(target, input, state: state) => ^expect
  ...
  def test_dump
    cases = {
      [Moonbase::Internal::Type::Unknown, B.new(a: "one", b: B.new(a: 1.0))] => {a: "one", b: {a: 1}},
      ...
      [Moonbase::Internal::Type::Boolean, true] => true,
      [Moonbase::Internal::Type::Boolean, "true"] => "true",
      [Integer, "1"] => "1",
      [Float, 1] => 1,
      [String, "one"] => "one",
      ...
      [String, Pathname(__FILE__)] => Moonbase::FilePart
    }
    ...
    cases.each do
      ...
      expect = _2
      assert_pattern do
        Moonbase::Internal::Type::Converter.dump(target, input) => ^expect
      end
    end
  end
  ...
  def test_coerce_errors
    ...
    cases.each do |testcase, expect|
      ...
      state = Moonbase::Internal::Type::Converter.new_coerce_state
      Moonbase::Internal::Type::Converter.coerce(target, input, state: state)
      assert_pattern do
        state => {error: ^expect}
      end
    end
  ...
  def test_dump_retry
    ...
    Pathname(__FILE__).open do |fd|
      ...
      types.product(cases).each do |target, input|
        ...
        Moonbase::Internal::Type::Converter.dump(target, input, state: state)
...
class Moonbase::Test::EnumModelTest < Minitest::Test
  class E0
    include Moonbase::Internal::Type::Enum
    attr_reader :values
...
class Moonbase::Test::CollectionModelTest < Minitest::Test
  A1 = Moonbase::Internal::Type::ArrayOf[-> { Integer }]
  H1 = Moonbase::Internal::Type::HashOf[Integer]

  A2 = Moonbase::Internal::Type::ArrayOf[H1]
  H2 = Moonbase::Internal::Type::HashOf[-> { A1 }]

  A3 = Moonbase::Internal::Type::ArrayOf[Integer, nil?: true]
  H3 = Moonbase::Internal::Type::HashOf[Integer, nil?: true]
...
class Moonbase::Test::BaseModelTest < Minitest::Test
  class M1 < Moonbase::Internal::Type::BaseModel
    required :a, Integer
  end
  ...
  class M3 < Moonbase::Internal::Type::BaseModel
    optional :c, const: :c
    required :d, const: :d
  end
  ...
  class M5 < Moonbase::Internal::Type::BaseModel
    request_only do
      required :c, const: :c
    end
  ...
  class M6 < M1
    required :a, Moonbase::Internal::Type::ArrayOf[M6]
    optional :b, M6
  end
  ...
  def test_coerce
    ...
    cases.each do |lhs, rhs|
      ...
      state = Moonbase::Internal::Type::Converter.new_coerce_state
      assert_pattern do
        coerced = Moonbase::Internal::Type::Converter.coerce(target, input, state: state)
        assert_equal(coerced, coerced)
        if coerced.is_a?(Moonbase::Internal::Type::BaseModel)
          coerced.to_h => ^expect
        else
          coerced => ^expect
        end
      ...
      attributes.each do |accessor, expect|
        ...
        in Class if expect <= StandardError
          tap do
            ...
            flunk
          rescue Moonbase::Errors::ConversionError => e
...
class Moonbase::Test::UnionTest < Minitest::Test
  class U0
    include Moonbase::Internal::Type::Union
  ...
  class M2 < Moonbase::Internal::Type::BaseModel
  ...
  class M4 < Moonbase::Internal::Type::BaseModel
    optional :recur, -> { U5 }
    required :a, Moonbase::Internal::Type::ArrayOf[-> { U5 }]
  end

  class M5 < Moonbase::Internal::Type::BaseModel
    optional :recur, -> { U5 }
    required :b, Moonbase::Internal::Type::ArrayOf[-> { U5 }]
  end
...
class Moonbase::Test::BaseModelQoLTest < Minitest::Test
  class E0
    include Moonbase::Internal::Type::Enum
    attr_reader :values
  ...
  def test_equality
    cases = {
      [Moonbase::Internal::Type::Unknown, Moonbase::Internal::Type::Unknown] => true,
      [Moonbase::Internal::Type::Boolean, Moonbase::Internal::Type::Boolean] => true,
      [Moonbase::Internal::Type::Unknown, Moonbase::Internal::Type::Boolean] => false,
...
class Moonbase::Test::MetaInfoTest < Minitest::Test
  A1 = Moonbase::Internal::Type::ArrayOf[Integer, nil?: true, doc: "dog"]
  H1 = Moonbase::Internal::Type::HashOf[-> { String }, nil?: true, doc: "dawg"]
