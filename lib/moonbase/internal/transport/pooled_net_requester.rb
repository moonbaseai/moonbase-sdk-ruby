      ...
      class PooledNetRequester
        ...
        class << self
          ...
          def calibrate_socket_timeout(conn, deadline)
            timeout = deadline - Moonbase::Internal::Util.monotonic_secs
        ...
        private def with_pool(url, deadline:, &blk)
          origin = Moonbase::Internal::Util.uri_origin(url)
          timeout = deadline - Moonbase::Internal::Util.monotonic_secs
          pool =
        ...
        def execute(request)
          ...
          enum = Enumerator.new do |y|
            ...
            raise Moonbase::Errors::APITimeoutError.new(url: url, request: req)
          rescue StandardError
            raise Moonbase::Errors::APIConnectionError.new(url: url, request: req)
          end
