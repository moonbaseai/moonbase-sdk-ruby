...
module Moonbase
  module Internal
    module Type
      ...
      # `Moonbase::Internal::Type::FileInput`.
      #
      ...
      class FileInput
        ...
        def self.===(other)
          case other
          in Pathname | StringIO | IO | String | Moonbase::FilePart
            true
          else
            false
          end
        ...
        #
        # @return [Boolean]
        def self.==(other) = other.is_a?(Class) && other <= Moonbase::Internal::Type::FileInput
        ...
        class << self
          ...
          # @return [Object]
          def to_sorbet_type
            T.any(Pathname, StringIO, IO, String, Moonbase::FilePart)
          end
        end
      end
    end
