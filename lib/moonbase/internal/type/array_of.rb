    ...
    module Type
      ...
      class ArrayOf
        ...
        def ==(other)
          ...
          other.is_a?(Moonbase::Internal::Type::ArrayOf) && other.nilable? == nilable? && other.item_type == item_type
          ...
          value
            .map do |item|
              ...
              in [true, nil]
                ...
                Moonbase::Internal::Type::Converter.coerce(target, item, state: state)
              end
            end
        end
        ...
        # @return [Object]
        def to_sorbet_type
          T::Array[Moonbase::Internal::Util::SorbetRuntimeSupport.to_sorbet_type(item_type)]
        end
