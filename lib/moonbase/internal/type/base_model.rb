    ...
    module Type
      ...
      class BaseModel
        ...
        class << self
          ...
          #
          # @param child [Class<Moonbase::Internal::Type::BaseModel>]
          def inherited(child)
            super
          ...
          private def add_field(name_sym, required:, type_info:, spec:)
            meta = Moonbase::Internal::Type::Converter.meta_info(type_info, spec)
            type_fn, info =
              case type_info
              in Proc | Moonbase::Internal::Type::Converter | Class
                [Moonbase::Internal::Type::Converter.type_info({**spec, union: type_info}), spec]
              in Hash
                [Moonbase::Internal::Type::Converter.type_info(type_info), type_info]
              end

            setter = :"#{name_sym}="
            api_name = info.fetch(:api_name, name_sym)
            nilable = info.fetch(:nil?, false)
            const = required && !nilable ? info.fetch(:const, Moonbase::Internal::OMIT) : Moonbase::Internal::OMIT
            ...
            define_method(setter) do |value|
              target = type_fn.call
              state = Moonbase::Internal::Type::Converter.new_coerce_state(translate_names: false)
              ...
              stored =
                case [target, status]
                in [Moonbase::Internal::Type::Converter | Symbol, true]
                  coerced
                else
                  value
                end
            ...
            define_method(name_sym) do
              ...
              in true | false if Moonbase::Internal::Type::Converter === target
                @data.fetch(name_sym)
              in ::StandardError => e
                raise Moonbase::Errors::ConversionError.new(
                  on: self.class,
                  method: __method__,
                  target: target,
                ...
                Kernel.then do
                  value = @data.fetch(name_sym) { const == Moonbase::Internal::OMIT ? nil : const }
                  state = Moonbase::Internal::Type::Converter.new_coerce_state(translate_names: false)
                  if (nilable || !required) && value.nil?
                    nil
                  else
                    Moonbase::Internal::Type::Converter.coerce(
          ...
          # @return [Boolean]
          def ==(other)
            other.is_a?(Class) && other <= Moonbase::Internal::Type::BaseModel && other.fields == fields
          end
        ...
        class << self
          # @api private
          #
          # @param value [Moonbase::Internal::Type::BaseModel, Hash{Object=>Object}, Object]
          #
          ...
          def coerce(value, state:)
            ...
            unless (val = Moonbase::Internal::Util.coerce_hash(value)).is_a?(Hash)
              exactness[:no] += 1
            ...
            fields.each do |name, field|
              ...
              unless val.key?(src_name)
                if required && mode != :dump && const == Moonbase::Internal::OMIT
              ...
              converted =
                if item.nil? && (nilable || !required)
                  ...
                  coerced = Moonbase::Internal::Type::Converter.coerce(target, item, state: state)
                  case target
                  in Moonbase::Internal::Type::Converter | Symbol
                    coerced
                  else
                    item
                  end
          ...
          def dump(value, state:)
            unless (coerced = Moonbase::Internal::Util.coerce_hash(value)).is_a?(Hash)
              return super
            end
            ...
            coerced.each do |key, val|
              ...
              in nil
                ...
                in :coerce
                  ...
                  target = type_fn.call
                  acc.store(api_name, Moonbase::Internal::Type::Converter.dump(target, val, state: state))
                end
              end
            end
            ...
            known_fields.each_value do |field|
              ...
              next if mode == :coerce || acc.key?(api_name) || const == Moonbase::Internal::OMIT
        ...
        class << self
          # @api private
          #
          # @param model [Moonbase::Internal::Type::BaseModel]
        ...
        #
        # @return [String]
        def to_json(*a) = Moonbase::Internal::Type::Converter.dump(self.class, self).to_json(*a)
        ...
        #
        # @return [String]
        def to_yaml(*a) = Moonbase::Internal::Type::Converter.dump(self.class, self).to_yaml(*a)
        ...
        def initialize(data = {})
          @data = {}
          @coerced = {}
          Moonbase::Internal::Util.coerce_hash!(data).each do
        ...
        class << self
          ...
          def inspect(depth: 0)
            ...
            deferred = fields.transform_values do |field|
              ...
              inspected = [
                Moonbase::Internal::Type::Converter.inspect(type, depth: depth),
