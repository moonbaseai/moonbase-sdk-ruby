...
module Moonbase
  module Models
    class MultiLineTextField < Moonbase::Internal::Type::BaseModel
      ...
      #
      #   @return [Symbol, Moonbase::Models::MultiLineTextField::Kind]
      required :kind, enum: -> { Moonbase::MultiLineTextField::Kind }
      ...
      # @!method initialize(id:, cardinality:, created_at:, default_values:, kind:, name:, readonly:, ref:, required:, unique:, updated_at:, description: nil, type: :"field/text/multi_line")
      ...
      #
      #   @param kind [Symbol, Moonbase::Models::MultiLineTextField::Kind] `system` fields are managed by Moonbase, `inverse` fields are the reverse side o
      #
      ...
      #
      #   @param type [Symbol, :"field/text/multi_line"] The data type of the field. Always `field/text/multi_line` for this field.

      # Specifies whether the field can hold a single value (`one`) or multiple values
      # (`many`).
      #
      # @see Moonbase::Models::MultiLineTextField#cardinality
      module Cardinality
      ...
      # of a two-way relation, and `custom` fields are user-created.
      #
      # @see Moonbase::Models::MultiLineTextField#kind
      module Kind
        extend Moonbase::Internal::Type::Enum
