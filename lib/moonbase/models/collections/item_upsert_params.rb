...
module Moonbase
  module Models
    module Collections
      # @see Moonbase::Resources::Collections::Items#upsert
      class ItemUpsertParams < Moonbase::Internal::Type::BaseModel
        ...
        required :identifiers,
                 -> { Moonbase::Internal::Type::HashOf[union: Moonbase::FieldValueParam, nil?: true] }
        ...
        #
        #   @return [Symbol, Moonbase::Models::Collections::ItemUpsertParams::UpdateManyStrategy, nil]
        optional :update_many_strategy, enum: -> { Moonbase::Collections::ItemUpsertParams::UpdateManyStrategy }
        ...
        #
        #   @param update_many_strategy [Symbol, Moonbase::Models::Collections::ItemUpsertParams::UpdateManyStrategy]
        #
        #   @param update_one_strategy [Symbol, Moonbase::Models::Collections::ItemUpsertParams::UpdateOneStrategy]
        #
