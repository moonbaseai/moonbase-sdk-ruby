...
module Moonbase
  module Models
    class SocialLinkedInField < Moonbase::Internal::Type::BaseModel
      ...
      #
      #   @return [Symbol, Moonbase::Models::SocialLinkedInField::Kind]
      required :kind, enum: -> { Moonbase::SocialLinkedInField::Kind }
      ...
      # @!method initialize(id:, cardinality:, created_at:, default_values:, kind:, name:, readonly:, ref:, required:, unique:, updated_at:, description: nil, type: :"field/uri/social_linked_in")
      ...
      #
      #   @param kind [Symbol, Moonbase::Models::SocialLinkedInField::Kind] `system` fields are managed by Moonbase, `inverse` fields are the reverse side o
      #
      ...
      #
      #   @param type [Symbol, :"field/uri/social_linked_in"] The data type of the field. Always `field/uri/social_linked_in` for this field.

      # Specifies whether the field can hold a single value (`one`) or multiple values
      # (`many`).
      #
      # @see Moonbase::Models::SocialLinkedInField#cardinality
      module Cardinality
      ...
      # of a two-way relation, and `custom` fields are user-created.
      #
      # @see Moonbase::Models::SocialLinkedInField#kind
      module Kind
        extend Moonbase::Internal::Type::Enum
