...
module Moonbase
  module Models
    class DateField < Moonbase::Internal::Type::BaseModel
      ...
      #   (`many`).
      #
      #   @return [Symbol, Moonbase::Models::DateField::Cardinality]
      required :cardinality, enum: -> { Moonbase::DateField::Cardinality }
      ...
      #
      #   @return [Symbol, Moonbase::Models::DateField::Kind]
      required :kind, enum: -> { Moonbase::DateField::Kind }
      ...
      # @!method initialize(id:, cardinality:, created_at:, default_values:, kind:, name:, readonly:, ref:, required:, unique:, updated_at:, description: nil, type: :"field/date")
      #   Some parameter documentations has been truncated, see
      #   {Moonbase::Models::DateField} for more details.
      #
      #   A field that stores dates without time information.
      #
      #   @param id [String] Unique identifier for the object.
      #
      #   @param cardinality [Symbol, Moonbase::Models::DateField::Cardinality] Specifies whether the field can hold a single value (`one`) or multiple values (
      #
      ...
      #
      #   @param kind [Symbol, Moonbase::Models::DateField::Kind] `system` fields are managed by Moonbase, `inverse` fields are the reverse side o
      #
      ...
      #
      #   @param type [Symbol, :"field/date"] The data type of the field. Always `field/date` for this field.

      # Specifies whether the field can hold a single value (`one`) or multiple values
      # (`many`).
      #
      # @see Moonbase::Models::DateField#cardinality
      module Cardinality
      ...
      # of a two-way relation, and `custom` fields are user-created.
      #
      # @see Moonbase::Models::DateField#kind
      module Kind
        extend Moonbase::Internal::Type::Enum
