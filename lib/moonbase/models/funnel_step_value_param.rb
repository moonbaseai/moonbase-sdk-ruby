...
module Moonbase
  module Models
    class FunnelStepValueParam < Moonbase::Internal::Type::BaseModel
      ...
      #
      #   @return [Moonbase::Models::FunnelStepPointer]
      required :data, -> { Moonbase::FunnelStepPointer }
      ...
      #   Funnel step value
      #
      #   @param data [Moonbase::Models::FunnelStepPointer] A specific funnel step, as configured on the Funnel.
      #
