...
module Moonbase
  module Models
    class ActivityProgramMessageSent < Moonbase::Internal::Type::BaseModel
      ...
      # @!method initialize(id:, occurred_at:, program_message:, recipient:, recipient_emails: nil, type: :"activity/program_message_sent")
      #   Some parameter documentations has been truncated, see
      #   {Moonbase::Models::ActivityProgramMessageSent} for more details.
      #
      ...
      #
      #   @param recipient_emails [Array<String>] List of email addresses the message was sent to.
      #
