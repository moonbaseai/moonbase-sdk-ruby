...
module Moonbase
  module Models
    class URLField < Moonbase::Internal::Type::BaseModel
      ...
      #
      #   @return [Symbol, Moonbase::Models::URLField::Kind]
      required :kind, enum: -> { Moonbase::URLField::Kind }
      ...
      # @!method initialize(id:, cardinality:, created_at:, default_values:, kind:, name:, readonly:, ref:, required:, unique:, updated_at:, description: nil, type: :"field/uri/url")
      ...
      #
      #   @param kind [Symbol, Moonbase::Models::URLField::Kind] `system` fields are managed by Moonbase, `inverse` fields are the reverse side o
      #
      ...
      # of a two-way relation, and `custom` fields are user-created.
      #
      # @see Moonbase::Models::URLField#kind
      module Kind
        extend Moonbase::Internal::Type::Enum
