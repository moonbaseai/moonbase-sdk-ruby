...
module Moonbase
  module Models
    class SocialXField < Moonbase::Internal::Type::BaseModel
      ...
      #   (`many`).
      #
      #   @return [Symbol, Moonbase::Models::SocialXField::Cardinality]
      required :cardinality, enum: -> { Moonbase::SocialXField::Cardinality }
      ...
      #
      #   @return [Symbol, Moonbase::Models::SocialXField::Kind]
      required :kind, enum: -> { Moonbase::SocialXField::Kind }
      ...
      # @!method initialize(id:, cardinality:, created_at:, default_values:, kind:, name:, readonly:, ref:, required:, unique:, updated_at:, description: nil, type: :"field/uri/social_x")
      #   Some parameter documentations has been truncated, see
      #   {Moonbase::Models::SocialXField} for more details.
      #
      #   A field that stores X (formerly Twitter) profile information.
      #
      #   @param id [String] Unique identifier for the object.
      #
      #   @param cardinality [Symbol, Moonbase::Models::SocialXField::Cardinality] Specifies whether the field can hold a single value (`one`) or multiple values (
      #
      ...
      #
      #   @param kind [Symbol, Moonbase::Models::SocialXField::Kind] `system` fields are managed by Moonbase, `inverse` fields are the reverse side o
      #
      #   @param name [String] The human-readable name of the field (e.g., "X Profile").
      #
      ...
      #
      #   @param type [Symbol, :"field/uri/social_x"] The data type of the field. Always `field/uri/social_x` for this field.

      # Specifies whether the field can hold a single value (`one`) or multiple values
      # (`many`).
      #
      # @see Moonbase::Models::SocialXField#cardinality
      module Cardinality
      ...
      # of a two-way relation, and `custom` fields are user-created.
      #
      # @see Moonbase::Models::SocialXField#kind
      module Kind
        extend Moonbase::Internal::Type::Enum
