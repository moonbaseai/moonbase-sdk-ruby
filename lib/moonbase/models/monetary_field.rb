...
module Moonbase
  module Models
    class MonetaryField < Moonbase::Internal::Type::BaseModel
      ...
      #
      #   @param type [Symbol, :"field/number/monetary"] The data type of the field. Always `field/number/monetary` for this field.

      # Specifies whether the field can hold a single value (`one`) or multiple values
      # (`many`).
      #
      # @see Moonbase::Models::MonetaryField#cardinality
      module Cardinality
