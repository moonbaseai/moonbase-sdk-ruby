...
module Moonbase
  module Models
    class GeoField < Moonbase::Internal::Type::BaseModel
      ...
      #
      #   @return [Symbol, Moonbase::Models::GeoField::Kind]
      ...
      # @!method initialize(id:, cardinality:, created_at:, default_values:, kind:, name:, readonly:, ref:, required:, unique:, updated_at:, description: nil, type: :"field/geo")
      ...
      #
      #   @param kind [Symbol, Moonbase::Models::GeoField::Kind] `system` fields are managed by Moonbase, `inverse` fields are the reverse side o
      #
      ...
      #
      #   @param type [Symbol, :"field/geo"] The data type of the field. Always `field/geo` for this field.

      # Specifies whether the field can hold a single value (`one`) or multiple values
      # (`many`).
      #
      # @see Moonbase::Models::GeoField#cardinality
      module Cardinality
      ...
      # of a two-way relation, and `custom` fields are user-created.
      #
      # @see Moonbase::Models::GeoField#kind
      module Kind
        extend Moonbase::Internal::Type::Enum
