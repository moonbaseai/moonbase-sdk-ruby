...
module Moonbase
  module Models
    class EmailField < Moonbase::Internal::Type::BaseModel
      ...
      #
      #   @return [Symbol, Moonbase::Models::EmailField::Kind]
      required :kind, enum: -> { Moonbase::EmailField::Kind }
      ...
      # @!method initialize(id:, cardinality:, created_at:, default_values:, kind:, name:, readonly:, ref:, required:, unique:, updated_at:, description: nil, type: :"field/email")
      ...
      #
      #   @param kind [Symbol, Moonbase::Models::EmailField::Kind] `system` fields are managed by Moonbase, `inverse` fields are the reverse side o
      #
      ...
      #
      #   @param type [Symbol, :"field/email"] The data type of the field. Always `field/email` for this field.

      # Specifies whether the field can hold a single value (`one`) or multiple values
      # (`many`).
      #
      # @see Moonbase::Models::EmailField#cardinality
      module Cardinality
      ...
      # of a two-way relation, and `custom` fields are user-created.
      #
      # @see Moonbase::Models::EmailField#kind
      module Kind
        extend Moonbase::Internal::Type::Enum
