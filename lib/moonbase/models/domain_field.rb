...
module Moonbase
  module Models
    class DomainField < Moonbase::Internal::Type::BaseModel
      ...
      #
      #   @return [Symbol, Moonbase::Models::DomainField::Kind]
      required :kind, enum: -> { Moonbase::DomainField::Kind }
      ...
      # @!method initialize(id:, cardinality:, created_at:, default_values:, kind:, name:, readonly:, ref:, required:, unique:, updated_at:, description: nil, type: :"field/uri/domain")
      ...
      #
      #   @param kind [Symbol, Moonbase::Models::DomainField::Kind] `system` fields are managed by Moonbase, `inverse` fields are the reverse side o
      #
      ...
      #
      #   @param type [Symbol, :"field/uri/domain"] The data type of the field. Always `field/uri/domain` for this field.

      # Specifies whether the field can hold a single value (`one`) or multiple values
      # (`many`).
      #
      # @see Moonbase::Models::DomainField#cardinality
      module Cardinality
      ...
      # of a two-way relation, and `custom` fields are user-created.
      #
      # @see Moonbase::Models::DomainField#kind
      module Kind
        extend Moonbase::Internal::Type::Enum
