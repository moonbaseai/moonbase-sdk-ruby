...
module Moonbase
  module Models
    class BooleanField < Moonbase::Internal::Type::BaseModel
      ...
      #
      #   @return [Symbol, Moonbase::Models::BooleanField::Kind]
      required :kind, enum: -> { Moonbase::BooleanField::Kind }
      ...
      # @!method initialize(id:, cardinality:, created_at:, default_values:, kind:, name:, readonly:, ref:, required:, unique:, updated_at:, description: nil, type: :"field/boolean")
      ...
      #
      #   @param kind [Symbol, Moonbase::Models::BooleanField::Kind] `system` fields are managed by Moonbase, `inverse` fields are the reverse side o
      #
      #   @param name [String] The human-readable name of the field (e.g., "Is Active").
      #
      ...
      #
      #   @param type [Symbol, :"field/boolean"] The data type of the field. Always `field/boolean` for this field.

      # Specifies whether the field can hold a single value (`one`) or multiple values
      # (`many`).
      #
      # @see Moonbase::Models::BooleanField#cardinality
      module Cardinality
      ...
      # of a two-way relation, and `custom` fields are user-created.
      #
      # @see Moonbase::Models::BooleanField#kind
      module Kind
        extend Moonbase::Internal::Type::Enum
