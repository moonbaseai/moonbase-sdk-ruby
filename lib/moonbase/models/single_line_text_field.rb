...
module Moonbase
  module Models
    class SingleLineTextField < Moonbase::Internal::Type::BaseModel
      ...
      #
      #   @return [Symbol, Moonbase::Models::SingleLineTextField::Kind]
      required :kind, enum: -> { Moonbase::SingleLineTextField::Kind }
      ...
      # @!method initialize(id:, cardinality:, created_at:, default_values:, kind:, name:, readonly:, ref:, required:, unique:, updated_at:, description: nil, type: :"field/text/single_line")
      ...
      #
      #   @param kind [Symbol, Moonbase::Models::SingleLineTextField::Kind] `system` fields are managed by Moonbase, `inverse` fields are the reverse side o
      #
      ...
      # of a two-way relation, and `custom` fields are user-created.
      #
      # @see Moonbase::Models::SingleLineTextField#kind
      module Kind
        extend Moonbase::Internal::Type::Enum
