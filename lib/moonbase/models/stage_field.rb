...
module Moonbase
  module Models
    class StageField < Moonbase::Internal::Type::BaseModel
      # @!attribute id
      ...
      required :funnel, -> { Moonbase::Funnel }
      ...
      #
      #   @return [Symbol, Moonbase::Models::StageField::Kind]
      required :kind, enum: -> { Moonbase::StageField::Kind }
      ...
      # @!method initialize(id:, cardinality:, created_at:, default_values:, funnel:, kind:, name:, readonly:, ref:, required:, unique:, updated_at:, description: nil, type: :"field/stage")
      ...
      #
      #   @param funnel [Moonbase::Models::Funnel] The `Funnel` object that defines the available stages for this field.
      #
      #   @param kind [Symbol, Moonbase::Models::StageField::Kind] `system` fields are managed by Moonbase, `inverse` fields are the reverse side o
      #
      #   @param name [String] The human-readable name of the field (e.g., "Sales Stage").
      #
      ...
      #
      #   @param type [Symbol, :"field/stage"] The data type of the field. Always `field/stage` for this field.

      # Specifies whether the field can hold a single value (`one`) or multiple values
      # (`many`).
      #
      # @see Moonbase::Models::StageField#cardinality
      module Cardinality
      ...
      # of a two-way relation, and `custom` fields are user-created.
      #
      # @see Moonbase::Models::StageField#kind
      module Kind
        extend Moonbase::Internal::Type::Enum
