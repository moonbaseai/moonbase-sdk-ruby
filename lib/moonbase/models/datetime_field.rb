...
module Moonbase
  module Models
    class DatetimeField < Moonbase::Internal::Type::BaseModel
      ...
      #
      #   @return [Symbol, Moonbase::Models::DatetimeField::Kind]
      required :kind, enum: -> { Moonbase::DatetimeField::Kind }
      ...
      # @!method initialize(id:, cardinality:, created_at:, default_values:, kind:, name:, readonly:, ref:, required:, unique:, updated_at:, description: nil, type: :"field/datetime")
      ...
      #
      #   @param kind [Symbol, Moonbase::Models::DatetimeField::Kind] `system` fields are managed by Moonbase, `inverse` fields are the reverse side o
      #
      ...
      # of a two-way relation, and `custom` fields are user-created.
      #
      # @see Moonbase::Models::DatetimeField#kind
      module Kind
        extend Moonbase::Internal::Type::Enum
