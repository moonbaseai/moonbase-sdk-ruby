...
module Moonbase
  module Models
    class IntegerField < Moonbase::Internal::Type::BaseModel
      ...
      #
      #   @return [Symbol, Moonbase::Models::IntegerField::Kind]
      required :kind, enum: -> { Moonbase::IntegerField::Kind }
      ...
      # @!method initialize(id:, cardinality:, created_at:, default_values:, kind:, name:, readonly:, ref:, required:, unique:, updated_at:, description: nil, type: :"field/number/unitless_integer")
      ...
      #
      #   @param kind [Symbol, Moonbase::Models::IntegerField::Kind] `system` fields are managed by Moonbase, `inverse` fields are the reverse side o
      #
      ...
      #
      #   @param type [Symbol, :"field/number/unitless_integer"] The data type of the field. Always `field/number/unitless_integer` for this fiel

      # Specifies whether the field can hold a single value (`one`) or multiple values
      # (`many`).
      #
      # @see Moonbase::Models::IntegerField#cardinality
      module Cardinality
      ...
      # of a two-way relation, and `custom` fields are user-created.
      #
      # @see Moonbase::Models::IntegerField#kind
      module Kind
        extend Moonbase::Internal::Type::Enum
