...
module Moonbase
  module Models
    class PercentageField < Moonbase::Internal::Type::BaseModel
      ...
      #
      #   @return [Symbol, Moonbase::Models::PercentageField::Kind]
      required :kind, enum: -> { Moonbase::PercentageField::Kind }
      ...
      # @!method initialize(id:, cardinality:, created_at:, default_values:, kind:, name:, readonly:, ref:, required:, unique:, updated_at:, description: nil, type: :"field/number/percentage")
      ...
      #
      #   @param kind [Symbol, Moonbase::Models::PercentageField::Kind] `system` fields are managed by Moonbase, `inverse` fields are the reverse side o
      #
      ...
      #
      #   @param type [Symbol, :"field/number/percentage"] The data type of the field. Always `field/number/percentage` for this field.

      # Specifies whether the field can hold a single value (`one`) or multiple values
      # (`many`).
      #
      # @see Moonbase::Models::PercentageField#cardinality
      module Cardinality
      ...
      # of a two-way relation, and `custom` fields are user-created.
      #
      # @see Moonbase::Models::PercentageField#kind
      module Kind
        extend Moonbase::Internal::Type::Enum
