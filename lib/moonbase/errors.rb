  ...
  module Errors
    ...
    class APIStatusError < Moonbase::Errors::APIError
      ...
      def self.for(url:, status:, body:, request:, response:, message: nil)
        ...
        case status
        in 400
          Moonbase::Errors::BadRequestError.new(**kwargs)
        in 401
          Moonbase::Errors::AuthenticationError.new(**kwargs)
        in 403
          Moonbase::Errors::PermissionDeniedError.new(**kwargs)
        in 404
          Moonbase::Errors::NotFoundError.new(**kwargs)
        in 409
          Moonbase::Errors::ConflictError.new(**kwargs)
        in 422
          Moonbase::Errors::UnprocessableEntityError.new(**kwargs)
        in 429
          Moonbase::Errors::RateLimitError.new(**kwargs)
        in (500..)
          Moonbase::Errors::InternalServerError.new(**kwargs)
        else
          Moonbase::Errors::APIStatusError.new(**kwargs)
        end
      end
