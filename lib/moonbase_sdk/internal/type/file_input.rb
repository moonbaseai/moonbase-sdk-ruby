...
module MoonbaseSDK
  module Internal
    module Type
      ...
      # `MoonbaseSDK::Internal::Type::FileInput`.
      #
      ...
      class FileInput
        ...
        def self.===(other)
          case other
          in Pathname | StringIO | IO | String | MoonbaseSDK::FilePart
            true
          else
            false
          end
        ...
        #
        # @return [Boolean]
        def self.==(other) = other.is_a?(Class) && other <= MoonbaseSDK::Internal::Type::FileInput
        ...
        class << self
          ...
          def dump(value, state:)
            ...
            in MoonbaseSDK::FilePart if value.content.is_a?(IO)
              state[:can_retry] = false
            else
            end
