    ...
    module Type
      ...
      module Converter
        ...
        def dump(value, state:)
          case value
          in Array
            value.map { MoonbaseSDK::Internal::Type::Unknown.dump(_1, state: state) }
          in Hash
            value.transform_values { MoonbaseSDK::Internal::Type::Unknown.dump(_1, state: state) }
          ...
          in Pathname | IO
            ...
            MoonbaseSDK::FilePart.new(value)
          in MoonbaseSDK::FilePart
        ...
        class << self
          ...
          def type_info(spec)
            ...
            in MoonbaseSDK::Internal::Type::Converter | Class | Symbol
              -> { spec }
          ...
          #
          # @param target [MoonbaseSDK::Internal::Type::Converter, Class]
          #
          # @param value [Object]
          #
          ...
          #
          # @return [Object]
          def coerce(target, value, state: MoonbaseSDK::Internal::Type::Converter.new_coerce_state)
            # rubocop:disable Metrics/BlockNesting
            exactness = state.fetch(:exactness)

            case target
            in MoonbaseSDK::Internal::Type::Converter
          ...
          def dump(target, value, state: {can_retry: true})
            ...
            in MoonbaseSDK::Internal::Type::Converter
              ...
              MoonbaseSDK::Internal::Type::Unknown.dump(value, state: state)
            end
          end
        ...
        define_sorbet_constant!(:Input) do
          T.type_alias { T.any(MoonbaseSDK::Internal::Type::Converter, T::Class[T.anything]) }
        end
