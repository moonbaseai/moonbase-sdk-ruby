...
module MoonbaseSDK
  module Internal
    ...
    #
    # @example
    #   cursor_page.auto_paging_each do |program_template|
    ...
    class CursorPage
      ...
      def next_page
        ...
        req = MoonbaseSDK::Internal::Util.deep_merge(@req, {query: {after: meta&.cursor&.next_}})
        @client.request(req)
      end
      ...
      # @api private
      #
      # @param client [MoonbaseSDK::Internal::Transport::BaseClient]
      ...
      def initialize(client:, req:, headers:, page_data:)
        ...
        case page_data
        in {data: Array => data}
          @data = data.map { MoonbaseSDK::Internal::Type::Converter.coerce(@model, _1) }
        else
        end
        case page_data
        in {meta: Hash | nil => meta}
          @meta = MoonbaseSDK::Internal::Type::Converter.coerce(MoonbaseSDK::Internal::CursorPage::Meta, meta)
        else
        end
      end
      ...
      # @return [String]
      def inspect
        model = MoonbaseSDK::Internal::Type::Converter.inspect(@model, depth: 1)
