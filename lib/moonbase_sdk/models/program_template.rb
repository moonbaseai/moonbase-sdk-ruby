...
module MoonbaseSDK
  module Models
    ...
    class ProgramTemplate < MoonbaseSDK::Internal::Type::BaseModel
      ...
      # @!attribute links
      #
      #   @return [MoonbaseSDK::Models::ProgramTemplate::Links]
      required :links, -> { MoonbaseSDK::ProgramTemplate::Links }
      ...
      #
      #   @return [MoonbaseSDK::Models::Program, nil]
      optional :program, -> { MoonbaseSDK::Program }
      ...
      #   {MoonbaseSDK::Models::ProgramTemplate} for more details.
      #
      ...
      #
      #   @param links [MoonbaseSDK::Models::ProgramTemplate::Links]
      #
      ...
      #
      #   @param program [MoonbaseSDK::Models::Program] The `Program` that uses this template.
      #
      ...
      # @see MoonbaseSDK::Models::ProgramTemplate#links
