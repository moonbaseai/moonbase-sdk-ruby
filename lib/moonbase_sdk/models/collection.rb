...
module MoonbaseSDK
  module Models
    ...
    class Collection < MoonbaseSDK::Internal::Type::BaseModel
      # @!attribute id
      ...
      #
      #   @return [MoonbaseSDK::Models::Collection::Links]
      required :links, -> { MoonbaseSDK::Collection::Links }
      ...
      #
      #   @return [Array<MoonbaseSDK::Models::Field>, nil]
      optional :fields, -> { MoonbaseSDK::Internal::Type::ArrayOf[MoonbaseSDK::Field] }
      ...
      #
      #   @return [Array<MoonbaseSDK::Models::View>, nil]
      optional :views, -> { MoonbaseSDK::Internal::Type::ArrayOf[MoonbaseSDK::View] }
      ...
      #   {MoonbaseSDK::Models::Collection} for more details.
      #
      ...
      #
      #   @param links [MoonbaseSDK::Models::Collection::Links] A hash of related links.
      #
      ...
      #
      #   @param fields [Array<MoonbaseSDK::Models::Field>] A list of `Field` objects that define the schema for items in this collection.
      #
      #   @param updated_at [Time] Time at which the object was last updated, as an RFC 3339 timestamp.
      #
      #   @param views [Array<MoonbaseSDK::Models::View>] A list of saved `View` objects for presenting the collection's data.
      #
      #   @param type [Symbol, :collection] String representing the object’s type. Always `collection` for this object.

      # @see MoonbaseSDK::Models::Collection#links
