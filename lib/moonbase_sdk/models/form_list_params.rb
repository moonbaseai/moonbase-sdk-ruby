...
module MoonbaseSDK
  module Models
    # @see MoonbaseSDK::Resources::Forms#list
    class FormListParams < MoonbaseSDK::Internal::Type::BaseModel
      ...
      #   `collection.fields`.
      #
      #   @return [Array<Symbol, MoonbaseSDK::Models::FormListParams::Include>, nil]
      optional :include,
               -> {
                 MoonbaseSDK::Internal::Type::ArrayOf[enum: MoonbaseSDK::FormListParams::Include]
               }
