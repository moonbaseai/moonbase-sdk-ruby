...
module MoonbaseSDK
  module Models
    ...
    class EmailMessage < MoonbaseSDK::Internal::Type::BaseModel
      ...
      # @!attribute links
      #
      #   @return [MoonbaseSDK::Models::EmailMessage::Links]
      required :links, -> { MoonbaseSDK::EmailMessage::Links }
      ...
      optional :addresses, -> { MoonbaseSDK::Internal::Type::ArrayOf[MoonbaseSDK::Address] }

      # @!attribute attachments
      #   A list of `Attachment` objects on the message.
      #
      #   @return [Array<MoonbaseSDK::Models::EmailMessage::Attachment>, nil]
      optional :attachments,
               -> {
                 MoonbaseSDK::Internal::Type::ArrayOf[MoonbaseSDK::EmailMessage::Attachment]
               }
      ...
      #
      #   @return [Boolean, nil]
      optional :bulk, MoonbaseSDK::Internal::Type::Boolean

      # @!attribute conversation
      #   The `Conversation` thread this message is part of.
      #
      #   @return [MoonbaseSDK::Models::InboxConversation, nil]
      optional :conversation, -> { MoonbaseSDK::InboxConversation }
      ...
      #
      #   @return [Boolean, nil]
      optional :draft, MoonbaseSDK::Internal::Type::Boolean
      ...
      #
      #   @return [Boolean, nil]
      optional :spam, MoonbaseSDK::Internal::Type::Boolean
      ...
      #
      #   @return [Boolean, nil]
      optional :trash, MoonbaseSDK::Internal::Type::Boolean

      # @!attribute unread
      #   `true` if the message has not been read.
      #
      #   @return [Boolean, nil]
      optional :unread, MoonbaseSDK::Internal::Type::Boolean
      ...
      #   {MoonbaseSDK::Models::EmailMessage} for more details.
      #
      #   The Email Message object represents a single email within a `Conversation`.
      #
      #   @param id [String] Unique identifier for the object.
      #
      #   @param links [MoonbaseSDK::Models::EmailMessage::Links]
      #
      ...
      #
      #   @param addresses [Array<MoonbaseSDK::Models::Address>] A list of `Address` objects associated with the message (sender and recipients).
      #
      #   @param attachments [Array<MoonbaseSDK::Models::EmailMessage::Attachment>] A list of `Attachment` objects on the message.
      #
      ...
      #
      #   @param conversation [MoonbaseSDK::Models::InboxConversation] The `Conversation` thread this message is part of.
      #
      ...
      # @see MoonbaseSDK::Models::EmailMessage#links
      ...
      class Attachment < MoonbaseSDK::Internal::Type::BaseModel
        ...
        #
        #   @return [MoonbaseSDK::Models::EmailMessage::Attachment::Links]
        required :links, -> { MoonbaseSDK::EmailMessage::Attachment::Links }
        ...
        #
        #   @param links [MoonbaseSDK::Models::EmailMessage::Attachment::Links] A hash of related links.
        #
        ...
        # @see MoonbaseSDK::Models::EmailMessage::Attachment#links
        class Links < MoonbaseSDK::Internal::Type::BaseModel
          # @!attribute conversation
          ...
          #   Some parameter documentations has been truncated, see
          #   {MoonbaseSDK::Models::EmailMessage::Attachment::Links} for more details.
          #
          #   A hash of related links.
          #
