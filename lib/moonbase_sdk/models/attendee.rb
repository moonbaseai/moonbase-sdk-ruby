...
module MoonbaseSDK
  module Models
    class Attendee < MoonbaseSDK::Internal::Type::BaseModel
      ...
      #
      #   @return [MoonbaseSDK::Models::Attendee::Links]
      required :links, -> { MoonbaseSDK::Attendee::Links }
      ...
      #
      #   @param links [MoonbaseSDK::Models::Attendee::Links] A hash of related links.
      #
      ...
      # @see MoonbaseSDK::Models::Attendee#links
