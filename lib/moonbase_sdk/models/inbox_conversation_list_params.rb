...
module MoonbaseSDK
  module Models
    # @see MoonbaseSDK::Resources::InboxConversations#list
    class InboxConversationListParams < MoonbaseSDK::Internal::Type::BaseModel
      ...
      #   `addresses` and `tags`.
      #
      #   @return [Array<Symbol, MoonbaseSDK::Models::InboxConversationListParams::Include>, nil]
      optional :include,
               -> {
                 MoonbaseSDK::Internal::Type::ArrayOf[enum: MoonbaseSDK::InboxConversationListParams::Include]
               }
