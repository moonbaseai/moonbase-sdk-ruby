...
module MoonbaseSDK
  module Models
    # @see MoonbaseSDK::Resources::InboxMessages#list
    class InboxMessageListParams < MoonbaseSDK::Internal::Type::BaseModel
      ...
      optional :conversation, MoonbaseSDK::Internal::Type::ArrayOf[String]

      # @!attribute inbox
      #   Filter messages by one or more inbox IDs.
      #
      #   @return [Array<String>, nil]
      optional :inbox, MoonbaseSDK::Internal::Type::ArrayOf[String]

      # @!attribute include
      #   Specifies which related objects to include in the response. Valid options are
      #   `addresses`, `attachments`, and `conversation`.
      #
      #   @return [Array<Symbol, MoonbaseSDK::Models::InboxMessageListParams::Include>, nil]
      optional :include,
               -> { MoonbaseSDK::Internal::Type::ArrayOf[enum: MoonbaseSDK::InboxMessageListParams::Include] }
