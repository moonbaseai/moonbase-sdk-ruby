...
module MoonbaseSDK
  module Models
    ...
    class Form < MoonbaseSDK::Internal::Type::BaseModel
      ...
      required :collection, -> { MoonbaseSDK::Collection }

      # @!attribute links
      #
      #   @return [MoonbaseSDK::Models::Form::Links]
      required :links, -> { MoonbaseSDK::Form::Links }
      ...
      #
      #   @return [Boolean, nil]
      optional :pages_enabled, MoonbaseSDK::Internal::Type::Boolean
      ...
      #
      #   @param collection [MoonbaseSDK::Models::Collection] The `Collection` that submissions to this form are saved to.
      #
      #   @param links [MoonbaseSDK::Models::Form::Links]
      #
      ...
      # @see MoonbaseSDK::Models::Form#links
