...
module MoonbaseSDK
  module Models
    # @see MoonbaseSDK::Resources::Files#retrieve
    class MoonbaseFile < MoonbaseSDK::Internal::Type::BaseModel
      # @!attribute id
      ...
      # @!attribute links
      #
      #   @return [MoonbaseSDK::Models::MoonbaseFile::Links]
      required :links, -> { MoonbaseSDK::MoonbaseFile::Links }
      ...
      #
      #   @param links [MoonbaseSDK::Models::MoonbaseFile::Links]
      #
      ...
      # @see MoonbaseSDK::Models::MoonbaseFile#links
      class Links < MoonbaseSDK::Internal::Type::BaseModel
        ...
        #   {MoonbaseSDK::Models::MoonbaseFile::Links} for more details.
        #
