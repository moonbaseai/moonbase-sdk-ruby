...
module MoonbaseSDK
  module Models
    # @see MoonbaseSDK::Resources::ProgramMessages#send_
    class ProgramMessageSendResponse < MoonbaseSDK::Internal::Type::BaseModel
      # @!attribute id
      ...
      # @!attribute links
      #
      #   @return [MoonbaseSDK::Models::ProgramMessageSendResponse::Links]
      required :links, -> { MoonbaseSDK::Models::ProgramMessageSendResponse::Links }
      ...
      #   {MoonbaseSDK::Models::ProgramMessageSendResponse} for more details.
      #
      ...
      #
      #   @param links [MoonbaseSDK::Models::ProgramMessageSendResponse::Links]
      #
      ...
      # @see MoonbaseSDK::Models::ProgramMessageSendResponse#links
