...
module MoonbaseSDK
  module Models
    ...
    class InboxConversation < MoonbaseSDK::Internal::Type::BaseModel
      ...
      # @!attribute links
      #
      #   @return [MoonbaseSDK::Models::InboxConversation::Links]
      required :links, -> { MoonbaseSDK::InboxConversation::Links }
      ...
      #
      #   @return [Boolean, nil]
      optional :closed, MoonbaseSDK::Internal::Type::Boolean
      ...
      #
      #   @return [Boolean, nil]
      optional :follow_up, MoonbaseSDK::Internal::Type::Boolean

      # @!attribute new_draft_conversation
      #   `true` if a new draft reply to this conversation has been started.
      #
      #   @return [Boolean, nil]
      optional :new_draft_conversation, MoonbaseSDK::Internal::Type::Boolean

      # @!attribute open_
      #   `true` if the conversation is currently open.
      #
      #   @return [Boolean, nil]
      optional :open_, MoonbaseSDK::Internal::Type::Boolean, api_name: :open
      ...
      #
      #   @return [Array<MoonbaseSDK::Models::InboxConversation::Tag>, nil]
      optional :tags, -> { MoonbaseSDK::Internal::Type::ArrayOf[MoonbaseSDK::InboxConversation::Tag] }
      ...
      #   {MoonbaseSDK::Models::InboxConversation} for more details.
      #
      #   The Conversation object represents a thread of related messages.
      #
      #   @param id [String] Unique identifier for the object.
      #
      #   @param links [MoonbaseSDK::Models::InboxConversation::Links]
      #
      #   @param addresses [Array<MoonbaseSDK::Models::Address>] A list of `Address` objects (participants) in this conversation.
      #
      ...
      #
      #   @param tags [Array<MoonbaseSDK::Models::InboxConversation::Tag>] A list of `Tag` objects applied to this conversation.
      #
      ...
      # @see MoonbaseSDK::Models::InboxConversation#links
