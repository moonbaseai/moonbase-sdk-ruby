  ...
  module Models
    class ProgramMessageSendResponse < MoonbaseSDK::Internal::Type::BaseModel
      OrHash =
        T.type_alias do
          T.any(
            MoonbaseSDK::Models::ProgramMessageSendResponse,
      ...
      sig { returns(MoonbaseSDK::Models::ProgramMessageSendResponse::Links) }
      attr_reader :links

      sig do
        params(
          links: MoonbaseSDK::Models::ProgramMessageSendResponse::Links::OrHash
        ).void
      end
      attr_writer :links
      ...
      class Links < MoonbaseSDK::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              MoonbaseSDK::Models::ProgramMessageSendResponse::Links,
              MoonbaseSDK::Internal::AnyHash
            )
          end
