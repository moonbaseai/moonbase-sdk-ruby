...
module MoonbaseSDK
  module Models
    class EmailMessage < MoonbaseSDK::Internal::Type::BaseModel
      OrHash =
        T.type_alias do
          T.any(MoonbaseSDK::EmailMessage, MoonbaseSDK::Internal::AnyHash)
        end
      ...
      sig { returns(MoonbaseSDK::EmailMessage::Links) }
      attr_reader :links

      sig { params(links: MoonbaseSDK::EmailMessage::Links::OrHash).void }
      attr_writer :links
      ...
      sig do
        returns(T.nilable(T::Array[MoonbaseSDK::EmailMessage::Attachment]))
      end
      attr_reader :attachments

      sig do
        params(
          attachments: T::Array[MoonbaseSDK::EmailMessage::Attachment::OrHash]
        ).void
      end
      ...
      sig { returns(T.nilable(MoonbaseSDK::InboxConversation)) }
      attr_reader :conversation

      sig { params(conversation: MoonbaseSDK::InboxConversation::OrHash).void }
      ...
      sig do
        params(
          id: String,
          links: MoonbaseSDK::EmailMessage::Links::OrHash,
          ...
          body_plain: String,
          bulk: T::Boolean,
          conversation: MoonbaseSDK::InboxConversation::OrHash,
          created_at: Time,
          draft: T::Boolean,
        ...
        override.returns(
          {
            ...
            attachments: T::Array[MoonbaseSDK::EmailMessage::Attachment],
            body_html: String,
            body_plain: String,
            bulk: T::Boolean,
      ...
      class Links < MoonbaseSDK::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              MoonbaseSDK::EmailMessage::Links,
      ...
      class Attachment < MoonbaseSDK::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              MoonbaseSDK::EmailMessage::Attachment,
              MoonbaseSDK::Internal::AnyHash
            )
          end
        ...
        sig { returns(MoonbaseSDK::EmailMessage::Attachment::Links) }
        attr_reader :links

        sig do
          params(
            links: MoonbaseSDK::EmailMessage::Attachment::Links::OrHash
          ).void
        end
        attr_writer :links
        ...
        class Links < MoonbaseSDK::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                MoonbaseSDK::EmailMessage::Attachment::Links,
                MoonbaseSDK::Internal::AnyHash
              )
            end
