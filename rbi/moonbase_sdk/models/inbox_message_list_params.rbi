  ...
  module Models
    class InboxMessageListParams < MoonbaseSDK::Internal::Type::BaseModel
      ...
      OrHash =
        T.type_alias do
          T.any(
            MoonbaseSDK::InboxMessageListParams,
      ...
      sig do
        returns(
          T.nilable(
            T::Array[MoonbaseSDK::InboxMessageListParams::Include::OrSymbol]
          )
        )
      end
      attr_reader :include
      ...
      module Include
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(Symbol, MoonbaseSDK::InboxMessageListParams::Include)
          end
        ...
        ADDRESSES =
          T.let(
            :addresses,
            MoonbaseSDK::InboxMessageListParams::Include::TaggedSymbol
          )
        ATTACHMENTS =
          T.let(
            :attachments,
        ...
        sig do
          override.returns(
            T::Array[MoonbaseSDK::InboxMessageListParams::Include::TaggedSymbol]
          )
        end
        def self.values
        end
