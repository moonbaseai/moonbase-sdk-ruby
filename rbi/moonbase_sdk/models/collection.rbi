...
module MoonbaseSDK
  module Models
    class Collection < MoonbaseSDK::Internal::Type::BaseModel
      OrHash =
        T.type_alias do
          T.any(MoonbaseSDK::Collection, MoonbaseSDK::Internal::AnyHash)
        end
      ...
      sig { returns(MoonbaseSDK::Collection::Links) }
      attr_reader :links

      sig { params(links: MoonbaseSDK::Collection::Links::OrHash).void }
      attr_writer :links
      ...
      sig { returns(T.nilable(T::Array[MoonbaseSDK::Field])) }
      attr_reader :fields

      sig { params(fields: T::Array[MoonbaseSDK::Field::OrHash]).void }
      attr_writer :fields
      ...
      sig { returns(T.nilable(T::Array[MoonbaseSDK::View])) }
      attr_reader :views

      sig { params(views: T::Array[MoonbaseSDK::View]).void }
      attr_writer :views
      ...
      sig do
        params(
          id: String,
          links: MoonbaseSDK::Collection::Links::OrHash,
          name: String,
          ref: String,
          created_at: Time,
          description: String,
          fields: T::Array[MoonbaseSDK::Field::OrHash],
          updated_at: Time,
          views: T::Array[MoonbaseSDK::View],
          type: Symbol
        ...
        override.returns(
          {
            ...
            created_at: Time,
            description: String,
            fields: T::Array[MoonbaseSDK::Field],
            updated_at: Time,
            views: T::Array[MoonbaseSDK::View]
          }
        )
