...
module MoonbaseSDK
  module Models
    class Attendee < MoonbaseSDK::Internal::Type::BaseModel
      OrHash =
        T.type_alias do
          T.any(MoonbaseSDK::Attendee, MoonbaseSDK::Internal::AnyHash)
        end
      ...
      sig { returns(MoonbaseSDK::Attendee::Links) }
      attr_reader :links

      sig { params(links: MoonbaseSDK::Attendee::Links::OrHash).void }
      attr_writer :links
      ...
      sig do
        params(
          id: String,
          email: String,
          links: MoonbaseSDK::Attendee::Links::OrHash,
          created_at: Time,
          updated_at: Time,
          type: Symbol
        ...
        override.returns(
          {
            id: String,
            email: String,
            links: MoonbaseSDK::Attendee::Links,
            type: Symbol,
            created_at: Time,
            updated_at: Time
          }
      ...
      class Links < MoonbaseSDK::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(MoonbaseSDK::Attendee::Links, MoonbaseSDK::Internal::AnyHash)
          end
