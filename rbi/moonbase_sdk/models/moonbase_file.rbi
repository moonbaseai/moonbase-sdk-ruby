...
module MoonbaseSDK
  module Models
    class MoonbaseFile < MoonbaseSDK::Internal::Type::BaseModel
      OrHash =
        T.type_alias do
          T.any(MoonbaseSDK::MoonbaseFile, MoonbaseSDK::Internal::AnyHash)
        end
      ...
      sig { returns(MoonbaseSDK::MoonbaseFile::Links) }
      attr_reader :links

      sig { params(links: MoonbaseSDK::MoonbaseFile::Links::OrHash).void }
      attr_writer :links
      ...
      sig do
        params(
          id: String,
          filename: String,
          links: MoonbaseSDK::MoonbaseFile::Links::OrHash,
          name: String,
          size: Float,
          created_at: Time,
          updated_at: Time,
      ...
      class Links < MoonbaseSDK::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              MoonbaseSDK::MoonbaseFile::Links,
