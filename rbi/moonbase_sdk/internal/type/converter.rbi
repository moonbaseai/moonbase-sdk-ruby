  ...
  module Internal
    module Type
      ...
      module Converter
        ...
        Input =
          T.type_alias do
            T.any(MoonbaseSDK::Internal::Type::Converter, T::Class[T.anything])
          end
        ...
        class << self
          ...
          sig do
            params(translate_names: T::Boolean).returns(
              MoonbaseSDK::Internal::Type::Converter::CoerceState
            )
          end
          ...
          sig do
            params(
              target: MoonbaseSDK::Internal::Type::Converter::Input,
              value: T.anything,
              state: MoonbaseSDK::Internal::Type::Converter::CoerceState
            ).returns(T.anything)
          end
