    ...
    module Type
      class BaseModel
        ...
        class << self
          ...
          sig { params(child: Moonbase::Internal::Type::BaseModel).void }
          def inherited(child)
          end
          ...
          sig do
            returns(
              T::Hash[
                Symbol,
                T.all(
                  Moonbase::Internal::Type::BaseModel::KnownField,
                  {
                    type_fn:
          ...
          sig do
            params(
              ...
              spec: Moonbase::Internal::AnyHash
            ).void
          end
          ...
          sig do
            override
              .params(
                ...
                state: Moonbase::Internal::Type::Converter::CoerceState
              )
          ...
          sig do
            override
              .params(
                ...
                state: Moonbase::Internal::Type::Converter::DumpState
              )
        ...
        class << self
          ...
          sig do
            params(
              model: Moonbase::Internal::Type::BaseModel,
              convert: T::Boolean
            ).returns(Moonbase::Internal::AnyHash)
          end
        ...
        sig { overridable.returns(Moonbase::Internal::AnyHash) }
        def to_h
        end
