  ...
  module Internal
    ...
    module Util
      ...
      class << self
        ...
        sig do
          params(url: T.any(URI::Generic, String)).returns(
            Moonbase::Internal::Util::ParsedUri
          )
        end
        def parse_uri(url)
        end
        ...
        # @api private
        sig do
          params(parsed: Moonbase::Internal::Util::ParsedUri).returns(
            URI::Generic
          )
        end
        ...
        sig do
          params(
            lhs: Moonbase::Internal::Util::ParsedUri,
            rhs: Moonbase::Internal::Util::ParsedUri
          ).returns(URI::Generic)
        end
      ...
      class << self
        # @api private
        sig do
          params(query: Moonbase::Internal::AnyHash).returns(
            Moonbase::Internal::AnyHash
          )
        end
        ...
        sig do
          params(
            collection: Moonbase::Internal::AnyHash,
            key: String,
            element: T.anything
          ).void
        end
      ...
      class << self
        ...
        sig do
          params(lines: T::Enumerable[String]).returns(
            T::Enumerable[Moonbase::Internal::Util::ServerSentEvent]
          )
        end
        ...
        class << self
          ...
          sig do
            params(
              type:
                T.any(
                  Moonbase::Internal::Util::SorbetRuntimeSupport,
                  T.anything
                )
            ).returns(T.anything)
          end
