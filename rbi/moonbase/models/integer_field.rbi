...
module Moonbase
  module Models
    class IntegerField < Moonbase::Internal::Type::BaseModel
      ...
      sig { returns(Moonbase::IntegerField::Kind::TaggedSymbol) }
      attr_accessor :kind
      ...
      sig do
        params(
          ...
          kind: Moonbase::IntegerField::Kind::OrSymbol,
          name: String,
          readonly: T::Boolean,
          ref: String,
          required: T::Boolean,
        ...
        override.returns(
          {
            ...
            kind: Moonbase::IntegerField::Kind::TaggedSymbol,
            name: String,
            readonly: T::Boolean,
            ref: String,
            required: T::Boolean,
      ...
      module Kind
        ...
        TaggedSymbol =
          T.type_alias { T.all(Symbol, Moonbase::IntegerField::Kind) }
        OrSymbol = T.type_alias { T.any(Symbol, String) }

        SYSTEM = T.let(:system, Moonbase::IntegerField::Kind::TaggedSymbol)
        INVERSE = T.let(:inverse, Moonbase::IntegerField::Kind::TaggedSymbol)
        CUSTOM = T.let(:custom, Moonbase::IntegerField::Kind::TaggedSymbol)

        sig do
          override.returns(T::Array[Moonbase::IntegerField::Kind::TaggedSymbol])
        end
        def self.values
        end
      end
