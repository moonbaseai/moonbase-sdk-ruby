...
module Moonbase
  module Models
    class DateField < Moonbase::Internal::Type::BaseModel
      OrHash =
        T.type_alias { T.any(Moonbase::DateField, Moonbase::Internal::AnyHash) }
      ...
      # (`many`).
      sig { returns(Moonbase::DateField::Cardinality::TaggedSymbol) }
      ...
      sig { returns(Moonbase::DateField::Kind::TaggedSymbol) }
      attr_accessor :kind
      ...
      sig do
        params(
          id: String,
          cardinality: Moonbase::DateField::Cardinality::OrSymbol,
          created_at: Time,
          default_values:
            T::Array[
              T.any(
          ...
          kind: Moonbase::DateField::Kind::OrSymbol,
          name: String,
          readonly: T::Boolean,
          ref: String,
          required: T::Boolean,
      ...
      sig do
        override.returns(
          {
            id: String,
            cardinality: Moonbase::DateField::Cardinality::TaggedSymbol,
            created_at: Time,
            default_values: T::Array[Moonbase::FieldDefaultValue::Variants],
            kind: Moonbase::DateField::Kind::TaggedSymbol,
            name: String,
            readonly: T::Boolean,
            ref: String,
            required: T::Boolean,
      ...
      module Cardinality
        ...
        TaggedSymbol =
          T.type_alias { T.all(Symbol, Moonbase::DateField::Cardinality) }
        OrSymbol = T.type_alias { T.any(Symbol, String) }

        ONE = T.let(:one, Moonbase::DateField::Cardinality::TaggedSymbol)
        MANY = T.let(:many, Moonbase::DateField::Cardinality::TaggedSymbol)

        sig do
          override.returns(
            T::Array[Moonbase::DateField::Cardinality::TaggedSymbol]
          )
        end
        def self.values
        end
      ...
      module Kind
        ...
        TaggedSymbol = T.type_alias { T.all(Symbol, Moonbase::DateField::Kind) }
        OrSymbol = T.type_alias { T.any(Symbol, String) }

        SYSTEM = T.let(:system, Moonbase::DateField::Kind::TaggedSymbol)
        INVERSE = T.let(:inverse, Moonbase::DateField::Kind::TaggedSymbol)
        CUSTOM = T.let(:custom, Moonbase::DateField::Kind::TaggedSymbol)

        sig do
          override.returns(T::Array[Moonbase::DateField::Kind::TaggedSymbol])
        end
        def self.values
        end
      end
