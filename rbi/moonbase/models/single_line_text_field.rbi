...
module Moonbase
  module Models
    class SingleLineTextField < Moonbase::Internal::Type::BaseModel
      OrHash =
        T.type_alias do
          T.any(Moonbase::SingleLineTextField, Moonbase::Internal::AnyHash)
        end
      ...
      # (`many`).
      sig { returns(Moonbase::SingleLineTextField::Cardinality::TaggedSymbol) }
      ...
      sig { returns(Moonbase::SingleLineTextField::Kind::TaggedSymbol) }
      attr_accessor :kind
      ...
      sig do
        params(
          id: String,
          cardinality: Moonbase::SingleLineTextField::Cardinality::OrSymbol,
          created_at: Time,
          default_values:
            T::Array[
              T.any(
          ...
          kind: Moonbase::SingleLineTextField::Kind::OrSymbol,
          name: String,
          readonly: T::Boolean,
          ref: String,
          required: T::Boolean,
        ...
        override.returns(
          {
            id: String,
            cardinality:
              Moonbase::SingleLineTextField::Cardinality::TaggedSymbol,
            created_at: Time,
            default_values: T::Array[Moonbase::FieldDefaultValue::Variants],
            kind: Moonbase::SingleLineTextField::Kind::TaggedSymbol,
            name: String,
            readonly: T::Boolean,
            ref: String,
            required: T::Boolean,
      ...
      module Cardinality
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(Symbol, Moonbase::SingleLineTextField::Cardinality)
          end
        OrSymbol = T.type_alias { T.any(Symbol, String) }

        ONE =
          T.let(:one, Moonbase::SingleLineTextField::Cardinality::TaggedSymbol)
        MANY =
          T.let(:many, Moonbase::SingleLineTextField::Cardinality::TaggedSymbol)

        sig do
          override.returns(
            T::Array[Moonbase::SingleLineTextField::Cardinality::TaggedSymbol]
          )
        end
        def self.values
        end
      ...
      module Kind
        ...
        TaggedSymbol =
          T.type_alias { T.all(Symbol, Moonbase::SingleLineTextField::Kind) }
        OrSymbol = T.type_alias { T.any(Symbol, String) }

        SYSTEM =
          T.let(:system, Moonbase::SingleLineTextField::Kind::TaggedSymbol)
        INVERSE =
          T.let(:inverse, Moonbase::SingleLineTextField::Kind::TaggedSymbol)
        CUSTOM =
          T.let(:custom, Moonbase::SingleLineTextField::Kind::TaggedSymbol)

        sig do
          override.returns(
            T::Array[Moonbase::SingleLineTextField::Kind::TaggedSymbol]
          )
        end
        def self.values
        end
