...
module Moonbase
  module Models
    class BooleanField < Moonbase::Internal::Type::BaseModel
      OrHash =
        T.type_alias do
          T.any(Moonbase::BooleanField, Moonbase::Internal::AnyHash)
        end
      ...
      # (`many`).
      sig { returns(Moonbase::BooleanField::Cardinality::TaggedSymbol) }
      ...
      sig { returns(Moonbase::BooleanField::Kind::TaggedSymbol) }
      attr_accessor :kind
      ...
      sig do
        params(
          id: String,
          cardinality: Moonbase::BooleanField::Cardinality::OrSymbol,
          created_at: Time,
          default_values:
            T::Array[
              T.any(
          ...
          kind: Moonbase::BooleanField::Kind::OrSymbol,
          name: String,
          readonly: T::Boolean,
          ref: String,
          required: T::Boolean,
      ...
      sig do
        override.returns(
          {
            id: String,
            cardinality: Moonbase::BooleanField::Cardinality::TaggedSymbol,
            created_at: Time,
            default_values: T::Array[Moonbase::FieldDefaultValue::Variants],
            kind: Moonbase::BooleanField::Kind::TaggedSymbol,
            name: String,
            readonly: T::Boolean,
            ref: String,
            required: T::Boolean,
      ...
      module Cardinality
        ...
        TaggedSymbol =
          T.type_alias { T.all(Symbol, Moonbase::BooleanField::Cardinality) }
        OrSymbol = T.type_alias { T.any(Symbol, String) }

        ONE = T.let(:one, Moonbase::BooleanField::Cardinality::TaggedSymbol)
        MANY = T.let(:many, Moonbase::BooleanField::Cardinality::TaggedSymbol)

        sig do
          override.returns(
            T::Array[Moonbase::BooleanField::Cardinality::TaggedSymbol]
          )
        end
        def self.values
        end
      ...
      module Kind
        ...
        TaggedSymbol =
          T.type_alias { T.all(Symbol, Moonbase::BooleanField::Kind) }
        OrSymbol = T.type_alias { T.any(Symbol, String) }

        SYSTEM = T.let(:system, Moonbase::BooleanField::Kind::TaggedSymbol)
        INVERSE = T.let(:inverse, Moonbase::BooleanField::Kind::TaggedSymbol)
        CUSTOM = T.let(:custom, Moonbase::BooleanField::Kind::TaggedSymbol)

        sig do
          override.returns(T::Array[Moonbase::BooleanField::Kind::TaggedSymbol])
        end
        def self.values
        end
      end
