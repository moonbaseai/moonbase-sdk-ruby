...
module Moonbase
  module Models
    class SocialXField < Moonbase::Internal::Type::BaseModel
      ...
      sig { returns(Moonbase::SocialXField::Kind::TaggedSymbol) }
      attr_accessor :kind
      ...
      sig do
        params(
          ...
          kind: Moonbase::SocialXField::Kind::OrSymbol,
          name: String,
          readonly: T::Boolean,
          ref: String,
          required: T::Boolean,
        ...
        override.returns(
          {
            ...
            kind: Moonbase::SocialXField::Kind::TaggedSymbol,
            name: String,
            readonly: T::Boolean,
            ref: String,
            required: T::Boolean,
      ...
      module Kind
        ...
        TaggedSymbol =
          T.type_alias { T.all(Symbol, Moonbase::SocialXField::Kind) }
        OrSymbol = T.type_alias { T.any(Symbol, String) }

        SYSTEM = T.let(:system, Moonbase::SocialXField::Kind::TaggedSymbol)
        INVERSE = T.let(:inverse, Moonbase::SocialXField::Kind::TaggedSymbol)
        CUSTOM = T.let(:custom, Moonbase::SocialXField::Kind::TaggedSymbol)

        sig do
          override.returns(T::Array[Moonbase::SocialXField::Kind::TaggedSymbol])
        end
        def self.values
        end
      end
