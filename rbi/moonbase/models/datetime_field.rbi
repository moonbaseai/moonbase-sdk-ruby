...
module Moonbase
  module Models
    class DatetimeField < Moonbase::Internal::Type::BaseModel
      OrHash =
        T.type_alias do
          T.any(Moonbase::DatetimeField, Moonbase::Internal::AnyHash)
        end
      ...
      # (`many`).
      sig { returns(Moonbase::DatetimeField::Cardinality::TaggedSymbol) }
      ...
      sig { returns(Moonbase::DatetimeField::Kind::TaggedSymbol) }
      attr_accessor :kind
      ...
      sig do
        params(
          id: String,
          cardinality: Moonbase::DatetimeField::Cardinality::OrSymbol,
          created_at: Time,
          default_values:
            T::Array[
              T.any(
          ...
          kind: Moonbase::DatetimeField::Kind::OrSymbol,
          name: String,
          readonly: T::Boolean,
          ref: String,
          required: T::Boolean,
      ...
      sig do
        override.returns(
          {
            id: String,
            cardinality: Moonbase::DatetimeField::Cardinality::TaggedSymbol,
            created_at: Time,
            default_values: T::Array[Moonbase::FieldDefaultValue::Variants],
            kind: Moonbase::DatetimeField::Kind::TaggedSymbol,
            name: String,
            readonly: T::Boolean,
            ref: String,
            required: T::Boolean,
      ...
      module Cardinality
        ...
        TaggedSymbol =
          T.type_alias { T.all(Symbol, Moonbase::DatetimeField::Cardinality) }
        OrSymbol = T.type_alias { T.any(Symbol, String) }

        ONE = T.let(:one, Moonbase::DatetimeField::Cardinality::TaggedSymbol)
        MANY = T.let(:many, Moonbase::DatetimeField::Cardinality::TaggedSymbol)

        sig do
          override.returns(
            T::Array[Moonbase::DatetimeField::Cardinality::TaggedSymbol]
          )
        end
        def self.values
        end
      ...
      module Kind
        ...
        TaggedSymbol =
          T.type_alias { T.all(Symbol, Moonbase::DatetimeField::Kind) }
        OrSymbol = T.type_alias { T.any(Symbol, String) }

        SYSTEM = T.let(:system, Moonbase::DatetimeField::Kind::TaggedSymbol)
        INVERSE = T.let(:inverse, Moonbase::DatetimeField::Kind::TaggedSymbol)
        CUSTOM = T.let(:custom, Moonbase::DatetimeField::Kind::TaggedSymbol)

        sig do
          override.returns(
            T::Array[Moonbase::DatetimeField::Kind::TaggedSymbol]
          )
        end
        def self.values
        end
