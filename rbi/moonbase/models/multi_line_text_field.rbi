...
module Moonbase
  module Models
    class MultiLineTextField < Moonbase::Internal::Type::BaseModel
      OrHash =
        T.type_alias do
          T.any(Moonbase::MultiLineTextField, Moonbase::Internal::AnyHash)
        end
      ...
      sig { returns(Moonbase::MultiLineTextField::Kind::TaggedSymbol) }
      attr_accessor :kind
      ...
      sig do
        params(
          ...
          kind: Moonbase::MultiLineTextField::Kind::OrSymbol,
          name: String,
          readonly: T::Boolean,
          ref: String,
          required: T::Boolean,
        ...
        override.returns(
          {
            ...
            kind: Moonbase::MultiLineTextField::Kind::TaggedSymbol,
            name: String,
            readonly: T::Boolean,
            ref: String,
            required: T::Boolean,
      ...
      module Cardinality
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(Symbol, Moonbase::MultiLineTextField::Cardinality)
          end
        OrSymbol = T.type_alias { T.any(Symbol, String) }

        ONE =
          T.let(:one, Moonbase::MultiLineTextField::Cardinality::TaggedSymbol)
        MANY =
          T.let(:many, Moonbase::MultiLineTextField::Cardinality::TaggedSymbol)

        sig do
          override.returns(
            T::Array[Moonbase::MultiLineTextField::Cardinality::TaggedSymbol]
          )
        end
        def self.values
        end
      ...
      module Kind
        ...
        TaggedSymbol =
          T.type_alias { T.all(Symbol, Moonbase::MultiLineTextField::Kind) }
        OrSymbol = T.type_alias { T.any(Symbol, String) }

        SYSTEM =
          T.let(:system, Moonbase::MultiLineTextField::Kind::TaggedSymbol)
        INVERSE =
          T.let(:inverse, Moonbase::MultiLineTextField::Kind::TaggedSymbol)
        CUSTOM =
          T.let(:custom, Moonbase::MultiLineTextField::Kind::TaggedSymbol)

        sig do
          override.returns(
            T::Array[Moonbase::MultiLineTextField::Kind::TaggedSymbol]
          )
        end
        def self.values
        end
