...
module Moonbase
  module Models
    class SocialLinkedInField < Moonbase::Internal::Type::BaseModel
      OrHash =
        T.type_alias do
          T.any(Moonbase::SocialLinkedInField, Moonbase::Internal::AnyHash)
        end
      ...
      # (`many`).
      sig { returns(Moonbase::SocialLinkedInField::Cardinality::TaggedSymbol) }
      ...
      sig { returns(Moonbase::SocialLinkedInField::Kind::TaggedSymbol) }
      attr_accessor :kind
      ...
      sig do
        params(
          id: String,
          cardinality: Moonbase::SocialLinkedInField::Cardinality::OrSymbol,
          created_at: Time,
          default_values:
            T::Array[
              T.any(
          ...
          kind: Moonbase::SocialLinkedInField::Kind::OrSymbol,
          name: String,
          readonly: T::Boolean,
          ref: String,
          required: T::Boolean,
        ...
        override.returns(
          {
            id: String,
            cardinality:
              Moonbase::SocialLinkedInField::Cardinality::TaggedSymbol,
            created_at: Time,
            default_values: T::Array[Moonbase::FieldDefaultValue::Variants],
            kind: Moonbase::SocialLinkedInField::Kind::TaggedSymbol,
            name: String,
            readonly: T::Boolean,
            ref: String,
            required: T::Boolean,
      ...
      module Cardinality
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(Symbol, Moonbase::SocialLinkedInField::Cardinality)
          end
        OrSymbol = T.type_alias { T.any(Symbol, String) }

        ONE =
          T.let(:one, Moonbase::SocialLinkedInField::Cardinality::TaggedSymbol)
        MANY =
          T.let(:many, Moonbase::SocialLinkedInField::Cardinality::TaggedSymbol)

        sig do
          override.returns(
            T::Array[Moonbase::SocialLinkedInField::Cardinality::TaggedSymbol]
          )
        end
        def self.values
        end
      ...
      module Kind
        ...
        TaggedSymbol =
          T.type_alias { T.all(Symbol, Moonbase::SocialLinkedInField::Kind) }
        OrSymbol = T.type_alias { T.any(Symbol, String) }

        SYSTEM =
          T.let(:system, Moonbase::SocialLinkedInField::Kind::TaggedSymbol)
        INVERSE =
          T.let(:inverse, Moonbase::SocialLinkedInField::Kind::TaggedSymbol)
        CUSTOM =
          T.let(:custom, Moonbase::SocialLinkedInField::Kind::TaggedSymbol)

        sig do
          override.returns(
            T::Array[Moonbase::SocialLinkedInField::Kind::TaggedSymbol]
          )
        end
        def self.values
        end
