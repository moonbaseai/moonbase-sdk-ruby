...
module Moonbase
  module Models
    class EmailField < Moonbase::Internal::Type::BaseModel
      OrHash =
        T.type_alias do
          T.any(Moonbase::EmailField, Moonbase::Internal::AnyHash)
        end
      ...
      # (`many`).
      sig { returns(Moonbase::EmailField::Cardinality::TaggedSymbol) }
      ...
      sig { returns(Moonbase::EmailField::Kind::TaggedSymbol) }
      attr_accessor :kind
      ...
      sig do
        params(
          id: String,
          cardinality: Moonbase::EmailField::Cardinality::OrSymbol,
          created_at: Time,
          default_values:
            T::Array[
              T.any(
          ...
          kind: Moonbase::EmailField::Kind::OrSymbol,
          name: String,
          readonly: T::Boolean,
          ref: String,
          required: T::Boolean,
      ...
      sig do
        override.returns(
          {
            id: String,
            cardinality: Moonbase::EmailField::Cardinality::TaggedSymbol,
            created_at: Time,
            default_values: T::Array[Moonbase::FieldDefaultValue::Variants],
            kind: Moonbase::EmailField::Kind::TaggedSymbol,
            name: String,
            readonly: T::Boolean,
            ref: String,
            required: T::Boolean,
      ...
      module Cardinality
        ...
        TaggedSymbol =
          T.type_alias { T.all(Symbol, Moonbase::EmailField::Cardinality) }
        OrSymbol = T.type_alias { T.any(Symbol, String) }

        ONE = T.let(:one, Moonbase::EmailField::Cardinality::TaggedSymbol)
        MANY = T.let(:many, Moonbase::EmailField::Cardinality::TaggedSymbol)

        sig do
          override.returns(
            T::Array[Moonbase::EmailField::Cardinality::TaggedSymbol]
          )
        end
        def self.values
        end
      ...
      module Kind
        ...
        TaggedSymbol =
          T.type_alias { T.all(Symbol, Moonbase::EmailField::Kind) }
        OrSymbol = T.type_alias { T.any(Symbol, String) }

        SYSTEM = T.let(:system, Moonbase::EmailField::Kind::TaggedSymbol)
        INVERSE = T.let(:inverse, Moonbase::EmailField::Kind::TaggedSymbol)
        CUSTOM = T.let(:custom, Moonbase::EmailField::Kind::TaggedSymbol)

        sig do
          override.returns(T::Array[Moonbase::EmailField::Kind::TaggedSymbol])
        end
        def self.values
        end
      end
