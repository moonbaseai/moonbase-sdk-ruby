...
module Moonbase
  module Models
    class FloatField < Moonbase::Internal::Type::BaseModel
      ...
      sig { returns(Moonbase::FloatField::Kind::TaggedSymbol) }
      attr_accessor :kind
      ...
      sig do
        params(
          ...
          kind: Moonbase::FloatField::Kind::OrSymbol,
          name: String,
          readonly: T::Boolean,
          ref: String,
          required: T::Boolean,
        ...
        override.returns(
          {
            ...
            kind: Moonbase::FloatField::Kind::TaggedSymbol,
            name: String,
            readonly: T::Boolean,
            ref: String,
            required: T::Boolean,
      ...
      module Kind
        ...
        TaggedSymbol =
          T.type_alias { T.all(Symbol, Moonbase::FloatField::Kind) }
        OrSymbol = T.type_alias { T.any(Symbol, String) }

        SYSTEM = T.let(:system, Moonbase::FloatField::Kind::TaggedSymbol)
        INVERSE = T.let(:inverse, Moonbase::FloatField::Kind::TaggedSymbol)
        CUSTOM = T.let(:custom, Moonbase::FloatField::Kind::TaggedSymbol)

        sig do
          override.returns(T::Array[Moonbase::FloatField::Kind::TaggedSymbol])
        end
        def self.values
        end
      end
