...
module Moonbase
  module Models
    class StageField < Moonbase::Internal::Type::BaseModel
      OrHash =
        T.type_alias do
          T.any(Moonbase::StageField, Moonbase::Internal::AnyHash)
        end
      ...
      module Cardinality
        ...
        TaggedSymbol =
          T.type_alias { T.all(Symbol, Moonbase::StageField::Cardinality) }
        OrSymbol = T.type_alias { T.any(Symbol, String) }

        ONE = T.let(:one, Moonbase::StageField::Cardinality::TaggedSymbol)
        MANY = T.let(:many, Moonbase::StageField::Cardinality::TaggedSymbol)
