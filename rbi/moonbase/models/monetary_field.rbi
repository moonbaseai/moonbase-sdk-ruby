...
module Moonbase
  module Models
    class MonetaryField < Moonbase::Internal::Type::BaseModel
      OrHash =
        T.type_alias do
          T.any(Moonbase::MonetaryField, Moonbase::Internal::AnyHash)
        end
      ...
      # (`many`).
      sig { returns(Moonbase::MonetaryField::Cardinality::TaggedSymbol) }
      ...
      sig { returns(Moonbase::MonetaryField::Kind::TaggedSymbol) }
      attr_accessor :kind
      ...
      sig do
        params(
          id: String,
          cardinality: Moonbase::MonetaryField::Cardinality::OrSymbol,
          created_at: Time,
          default_unit: String,
          default_values:
            T::Array[
          ...
          kind: Moonbase::MonetaryField::Kind::OrSymbol,
          name: String,
          readonly: T::Boolean,
          ref: String,
          required: T::Boolean,
      ...
      sig do
        override.returns(
          {
            id: String,
            cardinality: Moonbase::MonetaryField::Cardinality::TaggedSymbol,
            created_at: Time,
            default_unit: String,
            default_values: T::Array[Moonbase::FieldDefaultValue::Variants],
            kind: Moonbase::MonetaryField::Kind::TaggedSymbol,
            name: String,
            readonly: T::Boolean,
            ref: String,
            required: T::Boolean,
      ...
      module Cardinality
        ...
        TaggedSymbol =
          T.type_alias { T.all(Symbol, Moonbase::MonetaryField::Cardinality) }
        OrSymbol = T.type_alias { T.any(Symbol, String) }

        ONE = T.let(:one, Moonbase::MonetaryField::Cardinality::TaggedSymbol)
        MANY = T.let(:many, Moonbase::MonetaryField::Cardinality::TaggedSymbol)

        sig do
          override.returns(
            T::Array[Moonbase::MonetaryField::Cardinality::TaggedSymbol]
          )
        end
        def self.values
        end
      ...
      module Kind
        ...
        TaggedSymbol =
          T.type_alias { T.all(Symbol, Moonbase::MonetaryField::Kind) }
        OrSymbol = T.type_alias { T.any(Symbol, String) }

        SYSTEM = T.let(:system, Moonbase::MonetaryField::Kind::TaggedSymbol)
        INVERSE = T.let(:inverse, Moonbase::MonetaryField::Kind::TaggedSymbol)
        CUSTOM = T.let(:custom, Moonbase::MonetaryField::Kind::TaggedSymbol)

        sig do
          override.returns(
            T::Array[Moonbase::MonetaryField::Kind::TaggedSymbol]
          )
        end
        def self.values
        end
