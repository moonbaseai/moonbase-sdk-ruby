...
module Moonbase
  module Models
    class MeetingListParams < Moonbase::Internal::Type::BaseModel
      ...
      sig { returns(T.nilable(Moonbase::MeetingListParams::ICalUid)) }
      attr_reader :i_cal_uid

      sig do
        params(i_cal_uid: Moonbase::MeetingListParams::ICalUid::OrHash).void
      end
        ...
        override.returns(
          {
            after: String,
            before: String,
            i_cal_uid: Moonbase::MeetingListParams::ICalUid,
            limit: Integer,
      ...
      class ICalUid < Moonbase::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Moonbase::MeetingListParams::ICalUid,
