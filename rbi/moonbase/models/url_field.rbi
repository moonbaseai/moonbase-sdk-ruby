...
module Moonbase
  module Models
    class URLField < Moonbase::Internal::Type::BaseModel
      ...
      sig { returns(Moonbase::URLField::Kind::TaggedSymbol) }
      attr_accessor :kind
      ...
      sig do
        params(
          ...
          kind: Moonbase::URLField::Kind::OrSymbol,
          name: String,
          readonly: T::Boolean,
          ref: String,
          required: T::Boolean,
        ...
        override.returns(
          {
            ...
            kind: Moonbase::URLField::Kind::TaggedSymbol,
            name: String,
            readonly: T::Boolean,
            ref: String,
            required: T::Boolean,
      ...
      module Kind
        ...
        TaggedSymbol = T.type_alias { T.all(Symbol, Moonbase::URLField::Kind) }
        OrSymbol = T.type_alias { T.any(Symbol, String) }

        SYSTEM = T.let(:system, Moonbase::URLField::Kind::TaggedSymbol)
        INVERSE = T.let(:inverse, Moonbase::URLField::Kind::TaggedSymbol)
        CUSTOM = T.let(:custom, Moonbase::URLField::Kind::TaggedSymbol)

        sig do
          override.returns(T::Array[Moonbase::URLField::Kind::TaggedSymbol])
        end
        def self.values
        end
      end
